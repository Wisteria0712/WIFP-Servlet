...
<div class="layui-card-body">
    <form class="layui-form" action="${pageContext.request.contextPath}/LoginServlet.tran" method="post">
        <input type="text" name="userName" lay-verify="required" placeholder="用户名" class="layui-input" value="${cookie.userName.value}" />
        <input type="password" name="password" lay-verify="required" placeholder="密码" class="layui-input" value="${cookie.password.value}" />
