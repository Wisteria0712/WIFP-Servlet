...
<div class="layui-col-md5">
    <ul class="layui-nav layui-bg-gray">
        <li class="layui-nav-item">
            <a href="${pageContext.request.contextPath}/FetchAllNoteServlet.tran"
               style="color: gray;font-size: 20px;margin-top:15px">
                <i class="layui-icon layui-icon-release" style="color: black; font-size: 20px;margin-top:20px"></i>
                巡检反馈
            </a>
        </li>
        <li class="layui-nav-item">
            <a href="${pageContext.request.contextPath}/IndexServlet.tran"
               style="color: gray;font-size: 20px;margin-top:15px">
        ...
        <li class="layui-nav-item">
            <c:choose>
                <c:when test="${empty sessionScope.user}">
                    <a href="${pageContext.request.contextPath}/IndexServlet.tran?url=/register.jsp"
                       style="color: gray;font-size: 20px;margin-top:15px">
                        <i class="layui-icon layui-icon-add-circle"
                           style="color: black; font-size: 20px;margin-top:15px"></i>
                        注册
                    </a>
                </c:when>
                <c:otherwise>
                    <a href="${pageContext.request.contextPath}/FetchMyCommentServlet.tran"
                       style="color: gray;font-size: 20px;margin-top:15px">
                        <i class="layui-icon layui-icon-reply-fill"
                           style="color: black; font-size: 20px;margin-top:20px"></i>
                        我的反馈
                    </a>
                </c:otherwise>
            </c:choose>
